...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_validation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/validation */ \"./source/js/modules/validation.js\");\n\nnew _modules_validation__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('#register-form', {\n  password: function password(target) {\n    if (target.value.length < 4) {\n      target.parentNode.classList.add('field_error');\n      return false;\n    } else {\n      target.parentNode.classList.remove('field_error');\n      return true;\n    }\n  },\n  email: function email(target) {\n    var reqExpMail = /^(([^<>()[\\]\\\\.,;:\\s@\\\"]+(\\.[^<>()[\\]\\\\.,;:\\s@\\\"]+)*)|(\\\".+\\\"))@((\\[[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\])|(([a-zA-Z\\-0-9]+\\.)+[a-zA-Z]{2,}))$/;\n\n    if (reqExpMail.test(target.value)) {\n      target.parentNode.classList.remove('field_error');\n      return true;\n    } else {\n      target.parentNode.classList.add('field_error');\n      return false;\n    }\n  },\n  agreement: function agreement(target) {\n    if (target.checked) {\n      return true;\n    } else {\n      return false;\n    }\n  }\n});\n\n//# sourceURL=webpack:///./source/js/app.js?");

/***/ }),

/***/ "./source/js/modules/validation.js":
/*!*****************************************!*\
  !*** ./source/js/modules/validation.js ***!
  \*****************************************/
